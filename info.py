...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb://rctestuser:mymongopassword@mongo:27017/rocketchat?authSource=admin")   # IF Multiple Database Is False Then Fill Only This Database Url.
