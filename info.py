...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://trcrazy4u:multi@2010@cluster0.53ja9lj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "levifilterbot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'trcollection')
